...
public class DFSPathPanel extends JPanel {
    ...
    public DFSPathPanel(SocialNetwork network) {
    ...
    private void initializeUI() {
        ...
        JLabel title =
                new JLabel("Connection Path Finder (DFS)");
        ...
        startBox.setPreferredSize(new Dimension(220,30));
        endBox.setPreferredSize(new Dimension(220,30));

        JButton findButton =
                new JButton("Find Connection Path");

        findButton.setBackground(Theme.PRIMARY);
        findButton.setForeground(Color.WHITE);
        findButton.setFocusPainted(false);
        findButton.setFont(Theme.NORMAL);
    ...
    private void findPath() {
        ...
        List<String> visitedOrder =
                dfsResult.getVisitedOrder();

        resultArea.setText("");

        StringBuilder result = new StringBuilder();

        result.append("=== DFS CONNECTION PATH ===\n\n");
        result.append("From : ").append(start).append("\n");
        result.append("To   : ").append(end).append("\n\n");

        result.append("Alur Pencarian DFS:\n\n");
        ...
        if(path == null || path.isEmpty()) {
            ...
            result.append("Shortest Path DFS :\n\n");
